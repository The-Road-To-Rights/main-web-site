...
const HomeHistorySection = () => {
  return (
    <div className="bg-gradient-to-r from-white to-purple-200 via-purple-100 relative w-full min-h-screen flex flex-col md:flex-row">
      ...
      <div className="relative w-full md:w-1/2 h-[500px] md:h-auto flex justify-center items-center">
        <div className="relative w-[700px] h-[800px]"> {/* Adjust width and height based on the images */}
          ...
          {/* Image Two */}
          <div className="absolute top-[110px] left-[180px]  rotate-0 shadow-lg">
            <Image
              src={imageTwo}
              alt='Image Two'
          ...
          <div className="absolute top-[230px] left-[50px] md:left-[40px] rotate-0 shadow-lg">
            <Image
              src={imageThree}
              alt='Image Three'
          ...
          {/* Image One */}
          <div className="absolute top-[370px] left-[240px] rotate-0 shadow-lg">
            <Image
              src={imageOne}
              alt='Image One'
              className="rounded-[15px] opacity-100"
      ...
      <div className="w-full md:w-1/2 p-6 md:pl-14 md:pt-48">
        <h1 className="text-3xl md:text-4xl font-bold text-black mb-4">HISTORY</h1>
        <p className="text-black-600 text-lg md:text-2xl text-justify mb-6 pr-2 md:pr-6">
        ...
        <a href="#" className="text-purple-900 font-semibold flex items-center mt-4 hover:underline focus:underline transition-all duration-300 transform hover:-translate-y-1 pt-11">
